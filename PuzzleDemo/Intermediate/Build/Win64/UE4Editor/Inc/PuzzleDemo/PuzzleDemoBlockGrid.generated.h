...
#ifdef PUZZLEDEMO_PuzzleDemoBlockGrid_generated_h
#error "PuzzleDemoBlockGrid.generated.h already included, missing '#pragma once' in PuzzleDemoBlockGrid.h"
#endif
...
public: \
	DECLARE_CLASS(APuzzleDemoBlockGrid, AActor, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/PuzzleDemo"), PUZZLEDEMO_API) \
...
#define PuzzleDemo_Source_PuzzleDemo_PuzzleDemoBlockGrid_h_13_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(PUZZLEDEMO_API, APuzzleDemoBlockGrid); \
DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(APuzzleDemoBlockGrid); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	PUZZLEDEMO_API APuzzleDemoBlockGrid(APuzzleDemoBlockGrid&&); \
	PUZZLEDEMO_API APuzzleDemoBlockGrid(const APuzzleDemoBlockGrid&); \
public:
...
template<> PUZZLEDEMO_API UClass* StaticClass<class APuzzleDemoBlockGrid>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID PuzzleDemo_Source_PuzzleDemo_PuzzleDemoBlockGrid_h
