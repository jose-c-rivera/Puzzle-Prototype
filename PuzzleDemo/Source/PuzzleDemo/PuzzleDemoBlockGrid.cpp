...
APuzzleDemoBlockGrid::APuzzleDemoBlockGrid()
{
...
void APuzzleDemoBlockGrid::BeginPlay()
{
	Super::BeginPlay();
	...
	for(int32 BlockIndex=0; BlockIndex<NumBlocks; BlockIndex++)
	{
		...
		// Spawn a block
		APuzzleDemoBlock* NewBlock = GetWorld()->SpawnActor<APuzzleDemoBlock>(BlockLocation, FRotator(0,0,0));
...
void APuzzleDemoBlockGrid::AddScore()
{
	// Increment score
	Score++;
